...
global_variables() {
    ...
    # Blog title
    global_title="Mundo Linux"
    # The typical subtitle for each blog
    global_description="Um blog sobre Linux e linguagens de programação todo escrito no Terminal"
    # The public base URL for this blog
    global_url="https://heliogiroto.github.io/mundolinux"

    # Your name
    global_author="Hélio Giroto"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="https://github.com/HelioGiroto" 
    # Your email
    global_email="heliogiroto76@gmail.com"
    ...
    template_archive="Veja mais posts"
    # "All posts" (title of archive page)
    template_archive_title="Todos os posts"
    # "All tags"
    template_tags_title="Todas as tags"
    ...
    template_archive_index_page="Volta para página inicial"
    # "Subscribe" (used on bottom of index page, it is link to RSS feed)
    template_subscribe="Inscrever-se"
    # "Subscribe to this page..." (used as text for browser feed button that is embedded to html)
    template_subscribe_browser_button="Subscribe to this page..."
    # "Tweet" (used as twitter text button for posting to twitter)
    template_twitter_button="Tweet"
    template_twitter_comment="&lt;Deixe aqui o seu comentário, mas informe a URL para outras pessoas seguirem os comentários&gt;"
...
create_html_page() {
    ...
    # html, head
    {
        ...
        echo '<div class="headerholder"><img id="logo" src="images/logo.png" width="15%"><div class="header">'
        # blog title
        echo '<div id="title">'
        cat .title.html
...
create_css() {
    ...
    if [[ -f ../style.css ]] && [[ ! -f main.css ]]; then
        ...
        .headerholder{display:flex; flex-flow:row; padding:5px 10px; background-color:#f9f9f9;border-top:solid 1px #ccc;border-left:solid 1px #ccc;border-right:solid 1px #ccc;}
